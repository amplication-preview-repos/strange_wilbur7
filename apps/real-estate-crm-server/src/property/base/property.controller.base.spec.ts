  ...
  test("POST /properties", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        listingDate: CREATE_RESULT.listingDate.toISOString(),
      });
  });
      ...
      .expect([
        {
          ...
          listingDate: FIND_MANY_RESULT[0].listingDate.toISOString(),
        },
      ]);
  });
  ...
  test("GET /properties/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        listingDate: FIND_ONE_RESULT.listingDate.toISOString(),
      });
  });
